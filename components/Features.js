    ...
    <div className="mt-4 w-full text-black">
      ...
      <div className="w-full flex flex-col md:flex-row my-4 justify-between">
        <div className="w-full md:w-[30%] mt-2 shadow-md rounded-md px-2 py-8 flex flex-col items-center">
          ...
          <h4 className="font-bold">Handymen</h4>
          <div className="text-center my-2">
            You can&apos;t get access to a reliable handyman for your domestic
            repairs? We&apos;ve got you covered in that aspect
          </div>
        ...
        <div className="w-full md:w-[30%] mt-2 shadow-md rounded-md px-2 py-8 flex flex-col items-center">
          ...
          <h4 className="font-bold">Freelancers</h4>
          <div className="text-center my-2">
            You can&apos;t get access to a reliable handyman for your domestic
            repairs? We&apos;ve got you covered in that aspect
          </div>
